...
$root.packets = (function() {
    ...
    packets.Packet = (function() {
        ...
        /**
         * Packet params.
         * @type {(packets.Packet.Params$Properties|null)}
         */
        ...
        Packet.verify = function verify(message) {
            ...
            if (message.params != null && message.hasOwnProperty("params")) {
                var error = $root.packets.Packet.Params.verify(message.params);
                if (error)
                    return "params." + error;
            }
            return null;
        ...
        Packet.Params = (function() {

            /**
             * Properties of a Params.
             * @typedef packets.Packet.Params$Properties
             * @type {Object}
             ...
             * @exports packets.Packet.Params
             * @constructor
             * @param {packets.Packet.Params$Properties=} [properties] Properties to set
             */
             ...
             * @param {packets.Packet.Params$Properties=} [properties] Properties to set
             * @returns {packets.Packet.Params} Params instance
             */
            ...
            /**
             * Encodes the specified Params message. Does not implicitly {@link packets.Packet.Params.verify|verify} messages.
             * @param {packets.Packet.Params$Properties} message Params message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
            ...
            /**
             * Encodes the specified Params message, length delimited. Does not implicitly {@link packets.Packet.Params.verify|verify} messages.
             * @param {packets.Packet.Params$Properties} message Params message or plain object to encode
             * @param {$protobuf.Writer} [writer] Writer to encode to
             * @returns {$protobuf.Writer} Writer
             */
             ...
             * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
             * @param {number} [length] Message length if known beforehand
             * @returns {packets.Packet.Params} Params
             * @throws {Error} If the payload is not a reader or valid buffer
             * @throws {$protobuf.util.ProtocolError} If required fields are missing
             */
            Params.decode = function decode(reader, length) {
                if (!(reader instanceof $Reader))
                    reader = $Reader.create(reader);
                var end = length === undefined ? reader.len : reader.pos + length, message = new $root.packets.Packet.Params();
                while (reader.pos < end) {
                    var tag = reader.uint32();
                    switch (tag >>> 3) {
                    case 1:
            ...
            Params.fromObject = function fromObject(object) {
                if (object instanceof $root.packets.Packet.Params)
                    return object;
                var message = new $root.packets.Packet.Params();
            ...
            /**
             * Creates a Params message from a plain object. Also converts values to their respective internal types.
             * This is an alias of {@link packets.Packet.Params.fromObject}.
             * @function
             * @param {Object.<string,*>} object Plain object
             * @returns {packets.Packet.Params} Params
             */
             ...
             * @param {packets.Packet.Params} message Params
             * @param {$protobuf.ConversionOptions} [options] Conversion options
             * @returns {Object.<string,*>} Plain object
             */
